...
export class SEOService {
  static async generateSitemap(baseUrl = 'http://localhost:4000') {
    const staticRoutes = [
      ...
      { path: 'tvseries', priority: '0.95', changefreq: 'daily' },
      ...
      { path: 'animemovie', priority: '0.95', changefreq: 'daily' },
      { path: 'anime-movies', priority: '0.95', changefreq: 'daily' },
      { path: 'asian-drama', priority: '0.95', changefreq: 'daily' },
      { path: 'asiandrama', priority: '0.95', changefreq: 'daily' },
